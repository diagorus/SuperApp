...
import com.lordnikius.nstretching.shared.util.locale.StringUiData.Argument
import com.lordnikius.nstretching.shared.util.locale.StringUiData.Quantity
import com.lordnikius.nstretching.shared.util.locale.StringUiData.Resource
import com.lordnikius.nstretching.shared.util.locale.StringUiData.Value
...
@Composable
fun StringUiData.transformToStringCompose(): String {
    return when (this) {
        is Value -> {
            value
        }
