...
import com.lordnikius.nstretching.shared.generated.resources.text_to_speech_engine

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TextToSpeechEngineDropdown(
    modifier: Modifier,
    ...
    ExposedDropdownMenuBox(
        ...
        TextField(
            ...
            readOnly = true,
            label = {
                Text(stringResource(Res.string.text_to_speech_engine))
            },
